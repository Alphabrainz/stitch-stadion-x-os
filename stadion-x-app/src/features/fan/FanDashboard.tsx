...
import { DigitalTwinViewer } from '../digitalTwin/DigitalTwinViewer';
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-4 border-b border-white/10 pb-4">
           ...
           <h3 className="font-display text-xl font-bold tracking-widest uppercase text-white">Interactive Stadium Twin</h3>
        </div>
        <DigitalTwinViewer />
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 perspective-1000">
        <GlassCard onClick={() => navigate('/fan/tickets')} className="p-6 flex flex-col items-center justify-center gap-4 hover:border-primary/50 cursor-pointer group transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(212,175,55,0.2)] bg-black/40">
          ...
          <span className="font-bold tracking-[0.2em] uppercase text-xs text-center">Smart Ticket</span>
        </GlassCard>
        ...
        <GlassCard onClick={() => navigate('/fan/food')} className="p-6 flex flex-col items-center justify-center gap-4 hover:border-primary/50 cursor-pointer group transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(212,175,55,0.2)] bg-black/40">
          ...
          <span className="font-bold tracking-[0.2em] uppercase text-xs text-center">Order Food</span>
        </GlassCard>
        
        <GlassCard onClick={() => addToast('Interactive Seat Finder launched on map.', 'info')} className="p-6 flex flex-col items-center justify-center gap-4 hover:border-primary/50 cursor-pointer group transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(212,175,55,0.2)] bg-black/40">
          ...
          <span className="font-bold tracking-[0.2em] uppercase text-xs text-center">Seat Finder</span>
        </GlassCard>
        
        <GlassCard onClick={() => addToast('Smart Parking Guidance Activated', 'info')} className="p-6 flex flex-col items-center justify-center gap-4 hover:border-primary/50 cursor-pointer group transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(212,175,55,0.2)] bg-black/40">
          <span className="material-symbols-outlined text-4xl text-primary group-hover:scale-110 group-hover:drop-shadow-[0_0_15px_rgba(212,175,55,0.8)] transition-all">local_parking</span>
          <span className="font-bold tracking-[0.2em] uppercase text-xs text-center">Smart Parking</span>
        </GlassCard>
        
        <GlassCard onClick={() => addToast('Accessibility Assistance Requested', 'info')} className="p-6 flex flex-col items-center justify-center gap-4 hover:border-primary/50 cursor-pointer group transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(212,175,55,0.2)] bg-black/40">
          <span className="material-symbols-outlined text-4xl text-primary group-hover:scale-110 group-hover:drop-shadow-[0_0_15px_rgba(212,175,55,0.8)] transition-all">accessible_forward</span>
          <span className="font-bold tracking-[0.2em] uppercase text-xs text-center">Accessibility</span>
        </GlassCard>
